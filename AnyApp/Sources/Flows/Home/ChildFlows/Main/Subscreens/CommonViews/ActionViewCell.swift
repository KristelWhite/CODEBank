...
final class ActionViewCell: BackgroundPrimary {
...
extension ActionViewCell: ConfigurableView {
    ...
    struct Props: Hashable {
        ...
        public static func == (lhs: ActionViewCell.Props, rhs: ActionViewCell.Props) -> Bool {
